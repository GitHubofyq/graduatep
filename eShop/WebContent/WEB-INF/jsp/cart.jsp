	...
	<div class="span5">
		<div class="logo">
			<a href="http://localhost:8080/mango/">
				<img src="${ pageContext.request.contextPath}/image/r___________renleipic_01/logo.jpg" alt="网上商城logo">
			</a>
		</div>
	</div>
	...
	<s:if test="#session.cart.cartItems.size() != 0">
		<div class="span24">
			<div class="step step1">
				购物车（<font color="red"><s:property value="#session.cart.cartItems.size()"/></font>）
			</div>
				<table>
					<tbody><tr>
						<th>图片</th>
					...
					<s:iterator var="cartItem" value="#session.cart.cartItems">
						<tr>
							...
							<td>
								￥<s:property value="#cartItem.product.eshop_price"/>
							</td>
				...
				<div class="bottom">
					...
					<a href="${ pageContext.request.contextPath }/order_submitOrder.action" id="submit" class="submit">提交订单</a>
				</div>
		</div>
	</s:if>
	<s:else>
		<div class="span24">
			<div class="step step1">
				<span><h3>亲，你的购物车没有商品，请添加商品到购物车。</h3></span>
			</div>
		</div>
	</s:else>
</div>
