...
<script>
	...
	//验证码
	 function change(){
		...
		img1.src="${pageContext.request.contextPath}/captcha.action?"+ new Date().getTime();
	} 
</script>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											...
											<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/captcha.action" onclick="change()" title="点击更换验证码">
										</span>
