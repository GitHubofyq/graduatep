...
<div class="span24">
	<ul class="mainNav">
		...
		<li><a href=" ${pageContext.request.contextPath}/product_findByCid.action?cid=<s:property value="#category.cid"/>&currentPage=1 "><s:property value="#category.cname"/></a> |</li>
		</s:iterator>
		<!-- ?cid=<s:property value="#category.cid"/>&currentPage=1 -->
	</ul>
</div>
