...
<div class="container cart">
		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<div class="total">
					<em id="promotion"></em>
					商品金额: <strong id="effectivePrice">￥<font color="red"><s:property value="model.total"/></font></strong>
				</div>
			<form id="orderForm" action="${ pageContext.request.contextPath }/order_payOrder.action?oid=<s:property value="model.oid"/>" method="post">
				<%-- <input type="hidden" name="order.oid" value="<s:property value="model.oid"/>"/> --%>
				<div class="span24">
					<p>
							收货地址：<input  type="text" value="<s:property value="model.user.addr"/>" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input  type="text" value="<s:property value="model.user.name"/>" style="width:150px" />
								<br /> 
							联系方式：<input  type="text" value="<s:property value="model.user.phone"/>" style="width:150px" />
